...
<template>
    <div
        ...
        :class="[eventUi.density === 'minimal' && 'grid-cols-1 px-1 py-0.5', eventUi.isSelected && 'ring-2 ring-primary/40', eventUi.isDropValid === false && 'opacity-60']"
        :style="rootStyle"
        v-bind="$attrs"
    >
